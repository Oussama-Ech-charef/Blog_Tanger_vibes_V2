...
<div class="dashboard_layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar_nav">
            ...
            <a href="posts.php" class="sidebar_link <?= $current_page === 'posts.php' || $current_page === 'add_post.php' || $current_page === 'edit_post.php' ? 'active' : '' ?>">
            ...
            <a href="comments.php" class="sidebar_link <?= $current_page === 'comments.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-comments" aria-hidden="true"></i>
                <span>Comments</span>
            </a>
            <a href="messages.php" class="sidebar_link <?= $current_page === 'messages.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-envelope" aria-hidden="true"></i>
                <span>Messages</span>
            </a>
            <a href="users.php" class="sidebar_link <?= $current_page === 'users.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-users" aria-hidden="true"></i>
                <span>Users</span>
            </a>
            <a href="categories.php" class="sidebar_link <?= $current_page === 'categories.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-tags" aria-hidden="true"></i>
                <span>Categories</span>
            </a>
            <a href="settings.php" class="sidebar_link <?= $current_page === 'settings.php' ? 'active' : '' ?>">
