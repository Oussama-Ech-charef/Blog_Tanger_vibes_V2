...
<div style="padding:16px 24px;">
    <div class="dashboard_pagination">
        ...
        <?php if ($current_page > 1): ?><a href="notifications.php<?=$pre.($current_page-1)?>" class="page_btn" aria-label="Previous page"><i class="fa-solid fa-chevron-left" aria-hidden="true"></i></a><?php endif; ?>
        <?php for ($i=1;$i<=$total_pages;$i++): ?><a href="notifications.php<?=$pre.$i?>" class="page_btn <?=$i===$current_page?'active':''?>"><?=$i?></a><?php endfor; ?>
        <?php if ($current_page < $total_pages): ?><a href="notifications.php<?=$pre.($current_page+1)?>" class="page_btn" aria-label="Next page"><i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a><?php endif; ?>
    </div>
</div>
<?php endif; ?>
