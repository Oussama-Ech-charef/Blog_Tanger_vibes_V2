...
<head>
    ...
    <title>Details Tangier Vibes</title>
...
<body>
    ...
    <main>  
        ...
        <div class="detail_hero" style="background-image: url('../assets/img/home.jpg');">
            <div class="detail_header_content">
                <a href="../index.php" class="detail_back_btn">
                    <i class="fa-solid fa-arrow-left"></i> Back
                </a>
                <div>
                    <span class="detail_category">restorant</span>
                    <h1 class="detail_title">nakhile</h1>
                    <div class="detail_meta">
                        <span><i class="fa-solid fa-location-dot"></i> tanger,moroco</span>
                        <span><i class="fa-solid fa-eye"></i> 20.000</span>
                        <span><i class="fa-solid fa-calendar-days"></i> Posted 2 days ago</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="detail_main_card">
                <div class="detail_info_section">
                    ...
                    <div class="detail_description">
                        ...
                        <br>
                        <p>Whether you're looking for a breathtaking sunset or a glimpse into history at the Caves of Hercules nearby, Cap Spartel offers an unforgettable experience for every traveler visiting Tangier.</p>
                    </div>
                </div>
                    ...
                    <div class="premium_info_list">
                            ...
                            <div class="premium_info_item">
                                ...
                                <div class="item_text">
                                    ...
                                    <span class="item_value">Tourist Spot</span>
                                </div>
                            </div>
                            ...
                            <div class="premium_info_item">
                                ...
                                <div class="item_text">
                                    ...
                                    <span class="item_value">4,322</span>
                                </div>
                            </div>
                            ...
                            <div class="premium_info_item">
                                ...
                                <div class="item_text">
                                    ...
                                    <span class="item_value">Apr 17, 2026</span>
                                </div>
                            </div>
